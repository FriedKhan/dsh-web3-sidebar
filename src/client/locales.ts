...
export const zh = {
  ...
  w3Brand: 'DSH Web3',
  w3ConnectHeading: '连接你的钱包',
  w3ConnectSubtitle: '需要一个加密钱包来解锁侧边栏工作台，以及即将上线的 Solana Realms 治理。',
  w3MethodCreateTitle: '创建新钱包',
  w3MethodCreateDesc: '在本机生成一个 Solana 钱包，并用密码加密保存。',
  w3MethodImportTitle: '导入已有钱包',
  w3MethodImportDesc: '通过私钥或助记词恢复钱包。',
  w3MethodConnectTitle: '连接外部钱包',
  w3MethodConnectDesc: '使用 Phantom 或任意 Solana 钱包插件。',
  w3CreateHeading: '创建新钱包',
  w3ImportHeading: '导入钱包',
  w3ConnectHeadingExt: '连接外部钱包',
  w3UnlockHeading: '解锁钱包',
  w3UnlockSubtitle: '输入密码以解锁工作台。',
  w3PasswordLabel: '密码',
  w3PasswordPlaceholder: '设置一个高强度密码',
  w3ConfirmLabel: '确认密码',
  w3ConfirmPlaceholder: '再次输入密码',
  w3LabelLabel: '钱包名称（可选）',
  w3LabelPlaceholder: '如 主钱包',
  w3SecretLabel: '私钥或助记词',
  w3SecretPlaceholder: '粘贴 base58 私钥，或 12/24 位助记词',
  w3CreateAction: '创建钱包',
  w3ImportAction: '导入钱包',
  w3ConnectAction: '连接钱包',
  w3UnlockAction: '解锁',
  w3Back: '返回',
  w3Working: '处理中…',
  w3ForgetLink: '使用其他钱包',
  w3ErrPasswordShort: '密码至少 8 位。',
  w3ErrPasswordMismatch: '两次输入的密码不一致。',
  w3ErrSecretEmpty: '请输入私钥或助记词。',
  w3ErrWrongPassword: '密码错误，请重试。',
  w3CreateNote: 'UI 预览：此版本生成的是演示地址，不保存任何真实密钥；真实的密钥生成与加密密钥库将在下一步接入。',
  w3ConnectNote: 'UI 预览：外部钱包连接（Phantom / Solana 钱包标准）在此为模拟，将连接一个演示账户。',
  w3Loading: '正在检查钱包…',
  w3OverlapOn: '重叠模式：开（点击关闭）',
  w3OverlapOff: '重叠模式：关（点击开启）',
  w3BringForward: '前置侧栏',
  walletTab: '钱包',
  walletBalance: '余额',
  walletReceive: '收款',
  walletReceiveHint: '分享此地址以在 devnet 上接收 SOL。',
  walletSendTitle: '转账',
  walletRecipient: '收款地址',
  walletRecipientPlaceholder: 'Solana 地址',
  walletAmount: '金额（SOL）',
  walletSendAction: '发送',
  walletSending: '发送中…',
  walletSentSig: '已发送 — 查看交易',
  walletLock: '锁定',
  walletMethodCreated: '本地',
  walletMethodImported: '已导入',
  walletMethodConnected: '外部',
  ...
  realmsTab: '治理',
  realmsTitle: 'Solana Realms',
  realmsNoWallet: '未连接钱包',
  realmsAll: '全部 Realms',
  realmsMembers: '{count} 名成员',
  realmsYourPower: '你的投票权 {power} {symbol}',
  realmsActive: '{count} 个进行中',
  realmsStatusVoting: '投票中',
  realmsStatusSucceeded: '已通过',
  realmsStatusDefeated: '已否决',
  realmsStatusExecuting: '执行中',
  realmsYes: '赞成',
  realmsNo: '反对',
  realmsQuorum: '法定人数 {pct}%',
  realmsEndsIn: '{hours} 小时后结束',
  realmsPassing: '即将通过',
  realmsFailing: '未达标',
  realmsYouVoted: '你投了{choice}',
  realmsChangeVote: '修改投票',
  realmsCastVote: '以 {power} {symbol} 投票',
  realmsVoteYes: '赞成',
  realmsVoteNo: '反对',
  realmsVotingClosed: '投票已结束。',
  realmsNoPower: '你在 {realm} 没有投票权。',
  realmsConnectToVote: '连接钱包以投票。',
  realmsPreviewNote: 'UI 预览：Realms 数据为演示数据，投票仅在本地记录；真实的链上治理将在后续接入。',
  realmsVotedPill: '已投票',
  kanbanTab: '看板',
  kanbanTitle: '任务看板',
  kanbanNoWallet: '未连接钱包',
  kanbanDoneLabel: '已完成',
  kanbanPreviewNote: 'UI 预览：任务保存在本地。已完成的任务将作为贡献记录汇入治理进度图。',
  kanbanColBacklog: '待办池',
  kanbanColTodo: '待办',
  kanbanColDoing: '进行中',
  kanbanColReview: '评审',
  kanbanColDone: '完成',
  ...
  kanbanClaimMe: '认领给我',
  kanbanUnclaim: '取消认领',
  kanbanClaimNoWallet: '需先解锁钱包',
  kanbanAdd: '添加卡片',
  kanbanNewCard: '输入任务标题，回车添加',
}
...
export const en: Record<keyof typeof zh, string> = {
  ...
  w3Brand: 'DSH Web3',
  w3ConnectHeading: 'Connect your wallet',
  w3ConnectSubtitle: 'A crypto wallet unlocks the sidebar workbench and, soon, Solana Realms governance.',
  w3MethodCreateTitle: 'Create a new wallet',
  w3MethodCreateDesc: 'Generate a Solana wallet, encrypted with a password on this device.',
  w3MethodImportTitle: 'Import an existing wallet',
  w3MethodImportDesc: 'Restore from a secret key or seed phrase.',
  w3MethodConnectTitle: 'Connect an external wallet',
  w3MethodConnectDesc: 'Use Phantom or any Solana wallet extension.',
  w3CreateHeading: 'Create a new wallet',
  w3ImportHeading: 'Import a wallet',
  w3ConnectHeadingExt: 'Connect external wallet',
  w3UnlockHeading: 'Unlock your wallet',
  w3UnlockSubtitle: 'Enter your password to unlock the workbench.',
  w3PasswordLabel: 'Password',
  w3PasswordPlaceholder: 'Choose a strong password',
  w3ConfirmLabel: 'Confirm password',
  w3ConfirmPlaceholder: 'Re-enter your password',
  w3LabelLabel: 'Wallet name (optional)',
  w3LabelPlaceholder: 'e.g. Main wallet',
  w3SecretLabel: 'Secret key or seed phrase',
  w3SecretPlaceholder: 'Paste your base58 secret key or 12/24-word seed phrase',
  w3CreateAction: 'Create wallet',
  w3ImportAction: 'Import wallet',
  w3ConnectAction: 'Connect wallet',
  w3UnlockAction: 'Unlock',
  w3Back: 'Back',
  w3Working: 'Working…',
  w3ForgetLink: 'Use a different wallet',
  w3ErrPasswordShort: 'Use at least 8 characters.',
  w3ErrPasswordMismatch: 'Passwords do not match.',
  w3ErrSecretEmpty: 'Enter a secret key or seed phrase.',
  w3ErrWrongPassword: 'Wrong password. Try again.',
  w3CreateNote: 'UI preview: this build generates a demo address and stores no real key. Real keypair generation and an encrypted keystore land next.',
  w3ConnectNote: 'UI preview: external wallet connection (Phantom / Solana wallet-standard) is mocked here and connects a demo account.',
  w3Loading: 'Checking wallet…',
  ...
  walletReceiveHint: 'Share this address to receive SOL on devnet.',
  walletSendTitle: 'Send',
  walletRecipient: 'Recipient',
  walletRecipientPlaceholder: 'Solana address',
  walletAmount: 'Amount (SOL)',
  walletSendAction: 'Send',
  walletSending: 'Sending…',
  walletSentSig: 'Sent — view transaction',
  walletLock: 'Lock',
  walletMethodCreated: 'Local',
  walletMethodImported: 'Imported',
  walletMethodConnected: 'External',
  walletNetwork: 'Devnet',
  ...
  realmsTab: 'Governance',
  realmsTitle: 'Solana Realms',
  realmsNoWallet: 'No wallet connected',
  realmsAll: 'All realms',
  realmsMembers: '{count} members',
  realmsYourPower: 'Your power {power} {symbol}',
  realmsActive: '{count} active',
  realmsStatusVoting: 'Voting',
  realmsStatusSucceeded: 'Succeeded',
  realmsStatusDefeated: 'Defeated',
  realmsStatusExecuting: 'Executing',
  realmsYes: 'Yes',
  realmsNo: 'No',
  realmsQuorum: 'Quorum {pct}%',
  realmsEndsIn: 'ends in {hours}h',
  realmsPassing: 'passing',
  realmsFailing: 'below quorum',
  realmsYouVoted: 'You voted {choice}',
  realmsChangeVote: 'Change vote',
  realmsCastVote: 'Vote with {power} {symbol}',
  realmsVoteYes: 'Vote Yes',
  realmsVoteNo: 'Vote No',
  realmsVotingClosed: 'Voting has closed.',
  realmsNoPower: 'You have no voting power in {realm}.',
  realmsConnectToVote: 'Connect a wallet to vote.',
  realmsPreviewNote: 'UI preview: Realms data is mocked and votes are recorded locally only; real on-chain governance lands later.',
  realmsVotedPill: 'Voted',
  kanbanTab: 'Board',
  kanbanTitle: 'Task board',
  kanbanNoWallet: 'No wallet connected',
  kanbanDoneLabel: 'done',
  kanbanPreviewNote: 'UI preview: tasks are saved locally. Completed cards become the contribution signal that feeds the governance progress graphs.',
  kanbanColBacklog: 'Backlog',
  kanbanColTodo: 'To do',
  kanbanColDoing: 'In progress',
  kanbanColReview: 'Review',
  kanbanColDone: 'Done',
  kanbanPts: 'pts',
  kanbanEditHint: 'Click to edit',
  kanbanClaim: 'Claim',
  kanbanClaimMe: 'Claim for me',
  kanbanUnclaim: 'Unclaim',
