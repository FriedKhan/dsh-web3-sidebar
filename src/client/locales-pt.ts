export const pt: Record<string, string> = {
  files: 'Arquivos',
  fileTrace: 'Rastreio de arquivos',
  fileTraceEmpty: 'Ainda sem operações de arquivo nesta sessão',
  fileTraceRead: 'Leitura',
  fileTraceWrite: 'Escrita',
  fileTraceEdit: 'Edição',
  fileTraceRunning: 'em execução',
  fileTraceError: 'erro',
  fileTraceFold: '{count} linhas… clique para expandir',
  fileTraceContext: 'contexto',
  fileTracePriorUnknown: 'O conteúdo anterior está fora da janela; mostrado como totalmente adicionado',
  explorer: 'Explorador',
