export const sv: Record<string, string> = {
  files: 'Filer',
  fileTrace: 'Filspårning',
  fileTraceEmpty: 'Inga filoperationer i den här sessionen ännu',
  fileTraceRead: 'Läs',
  fileTraceWrite: 'Skriv',
  fileTraceEdit: 'Redigera',
  fileTraceRunning: 'körs',
  fileTraceError: 'fel',
  fileTraceFold: '{count} rader… klicka för att expandera',
  fileTraceContext: 'kontext',
  fileTracePriorUnknown: 'Innehållet före ändringen ligger utanför fönstret; visas som helt nytt',
  explorer: 'Utforskare',
